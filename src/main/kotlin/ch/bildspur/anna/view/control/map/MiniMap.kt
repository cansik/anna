package ch.bildspur.anna.view.control.map

import ch.bildspur.anna.event.Event
import ch.bildspur.anna.view.control.ResizableCanvas
import ch.bildspur.anna.view.control.map.tool.IEditorTool
import ch.bildspur.anna.view.control.map.tool.ViewTool
